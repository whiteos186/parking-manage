<template>
  <div class="app-container">
    <el-page-header @back="goBack" :content="isEdit ? '修改会员订单' : '新增会员订单'" style="margin-bottom: 20px" />
    <el-card>
...
import { MEMBERSHIP_TYPE_OPTIONS, formatCustomerOption, formatVehicleOption } from '../options'
