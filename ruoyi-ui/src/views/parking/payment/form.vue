<template>
  <div class="app-container">
    <el-page-header @back="goBack" :content="isEdit ? '修改支付流水' : '新增支付流水'" style="margin-bottom: 20px" />
    <el-card>
      <el-form ref="form" :model="form" :rules="rules" label-width="110px" v-loading="loading">
        <el-form-item label="业务订单号" prop="bizOrderNo">
          <el-input v-model="form.bizOrderNo" placeholder="请输入业务订单号" maxlength="32" show-word-limit style="width: 360px" />
        </el-form-item>
